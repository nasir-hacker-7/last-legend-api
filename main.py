...
# ==================== ANTI-BAN DELAYS ====================
MSG_DELAY = 3              # ⏳ Har message ke baad 3 sec
BATCH_DELAY = 15           # ⏳ Har batch ke baad 15 sec
RATE_LIMIT_DELAY = 30      # ⏳ Rate limit par 30 sec
...
def process_records_in_batches(records):
    ...
    for i in range(0, total_records, BATCH_SIZE):
        ...
        for record in batch:
            try:
                ...
                if msg_id not in processed_messages:
                    ...
                    # ✅ ANTI-BAN: Har message ke baad 3 sec
                    print(f"  ⏳ Anti-ban delay {MSG_DELAY}s...")
        ...
        if i + BATCH_SIZE < total_records:
            # ✅ ANTI-BAN: Har batch ke baad 15 sec
            print(f"⏳ Batch done. Anti-ban wait {BATCH_DELAY}s...")
